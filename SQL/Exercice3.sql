...
-- 2.
SELECT first_name, last_name, salary, job
FROM Users 
...
FROM Users 
WHERE salary BETWEEN 1500 AND 3000 AND job = "Designer";

-- Partie 2. --
-- 4.
SELECT AVG(salary) as 'Moyenne de salaire'
FROM Users;

-- 5.
SELECT COUNT(*), birth_location
FROM Users 
WHERE age > 30
...
-- 13. 
SELECT birth_location, COUNT(*) as nombre_de_personnes
FROM Users 
GROUP BY birth_location
HAVING AVG(age) < 35
AND nombre_de_personnes >= 2;
